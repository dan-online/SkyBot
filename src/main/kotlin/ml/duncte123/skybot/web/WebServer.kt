        ...
        path("/server/:guildid") {
            ...
            post("/") {
                ...
                val newSettings = GuildSettingsUtils.getGuild(guild)
                        .setCustomPrefix(prefix ?: AirUtils.CONFIG.getString("discord.prefix"))
                        .setServerDesc(serverDescription ?: "")
                        .setWelcomeLeaveChannel(welcomeChannel)
                        .setCustomJoinMessage(welcomeMessage ?: GuildSettingsUtils.getGuild(guild).customJoinMessage)
                        .setCustomLeaveMessage(leaveMessage ?: GuildSettingsUtils.getGuild(guild).customLeaveMessage)
